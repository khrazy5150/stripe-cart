...
// --- API helpers ---
const API_URL = 'https://6npji51i86.execute-api.us-west-2.amazonaws.com/dev/';
...
//   await preloadAllProductPrices();
//   await loadProductInfo();   // 👈 ensures productData is set for default card
...
//   // Ensure default state for shipping section
//   if (sameAsBillingCheckbox) {
//     sameAsBillingCheckbox.checked = true;
//     toggleShippingSection();
//     syncShippingFields(true);
...
//   // Ensure default state: checkbox checked, section hidden, fields synced/disabled
//   if (sameAsBillingCheckbox) {
//     sameAsBillingCheckbox.checked = true;  // default checked via JS (also feel free to add `checked` in HTML)
//     toggleShippingSection();
//     syncShippingFields(true);
//   }
// });