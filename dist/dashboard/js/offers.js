            ...
            <article class="offer-card ${offer.active ? '' : 'offer-card--inactive'}" data-offer-key="${safeHtml(offer.key)}">
                ...
                <div class="offer-card-body">
                    ...
                    <div class="offer-card-actions">
                        <button class="small" data-offer-action="view" data-offer-key="${safeHtml(offer.key)}">View</button>
                        <button class="small secondary" data-offer-action="edit" data-offer-key="${safeHtml(offer.key)}">Edit</button>
                        <button class="small danger" data-offer-action="delete" data-offer-key="${safeHtml(offer.key)}">Delete</button>
                    </div>
                </div>
            </article>
        `;
